...
* The original package name 'com.amdocs.media.assignement.amdocs-authorization-service' is invalid and this project uses 'com.amdocs.media.assignement.amdocsauthorizationservice' instead.
